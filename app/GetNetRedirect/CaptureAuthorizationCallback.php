...
class CaptureAuthorizationCallback
{
    ...
    {
        $act = new CaptureAuthorizationCallback($order, $settings, $currentTransactionType, $transactionId);
        return $act->processCaptureAuthorization();
    }

    public function processCaptureAuthorization()
    {
        ...
        $payload = WcOrderCaptureAuthorizationPayload::getPayload(
            $this->order,
            $this->settings,
            $processedBy,
            $purchaseRequestId,
